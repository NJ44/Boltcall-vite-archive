...
const blogPosts: BlogPost[] = [
  ...
  {
    title: 'Why Local Service Businesses Lose Customers by Not Answering Calls Quickly Enough',
    slug: '/blog/why-local-service-businesses-lose-customers-not-answering-calls',
    excerpt: 'Local service businesses lose customers because callers are in urgency mode and call multiple businesses simultaneously. Learn why slow response is costing you jobs.',
    date: 'May 21, 2026',
    readTime: '8 min read',
    category: 'Speed to Lead|Local Business',
    image: '/images/blog/comparison-generic.png',
  },
  {
    title: 'Does Response Time Affect Whether a Local Business Gets the Job?',
    slug: '/blog/does-response-time-affect-whether-local-business-gets-job',
    excerpt: 'MIT research shows responding in under 60 seconds makes you 391% more likely to convert a lead. See how response time determines who gets the job.',
    date: 'May 21, 2026',
    readTime: '8 min read',
    category: 'Speed to Lead|Local Business',
    image: '/images/blog/comparison-generic.png',
  ...
  {
    title: 'Fastest Way for Dentists to Respond to Missed Calls Automatically',
    slug: '/blog/fastest-way-dentist-respond-missed-calls-automatically',
    excerpt: 'AI phone agents answer dental practice calls in under 3 seconds, book appointments into Dentrix or Open Dental, and follow up every missed call — 24/7.',
    date: 'May 21, 2026',
    readTime: '9 min read',
    category: 'AI Receptionist|Industry Guide',
    image: '/images/blog/ai-dental-medical.png',
  },
  {
  ...
  },
  {
    ...
    slug: '/blog/best-ai-receptionist-companies-local-service',
    excerpt: 'Compare the top AI receptionist companies for HVAC, plumbing, dental, and other local services. Boltcall, Smith.ai, Goodcall, Numa, and more reviewed.',
    date: 'April 30, 2026',
    readTime: '8 min read',
    category: 'Tool Comparison',
  },
  {
    title: 'Which AI Virtual Receptionist Has the Best Customer Reviews?',
    slug: '/blog/best-ai-virtual-receptionist-customer-reviews',
    excerpt: 'See G2, Capterra, and Trustpilot ratings for the top AI virtual receptionists in 2026. Boltcall, Smith.ai, Goodcall, Numa, and AnswerForce compared.',
    date: 'April 30, 2026',
    readTime: '7 min read',
    category: 'Tool Comparison',
  },
  {
    title: 'Best-Rated AI Virtual Receptionist for Voice Quality (2026)',
    slug: '/blog/best-rated-ai-virtual-receptionist-voice-quality',
    excerpt: 'Compare AI virtual receptionists by voice quality. Boltcall leads with ElevenLabs Turbo v3 at 220ms latency. Full comparison with Numa, Air.ai, Goodcall, and Smith.ai.',
    date: 'April 30, 2026',
    readTime: '7 min read',
    category: 'Tool Comparison',
  },
...
const moreFromBoltcall: { label: string; href: string; tagline: string }[] = [
  ...
  { label: 'Best AI Receptionist Companies 2026', href: '/blog/best-ai-receptionist-companies-local-service', tagline: 'Top picks for local service businesses.' },
  { label: 'Best-Reviewed AI Virtual Receptionists', href: '/blog/best-ai-virtual-receptionist-customer-reviews', tagline: 'G2, Capterra, and Trustpilot ratings compared.' },
  { label: 'Best AI Receptionist for Voice Quality', href: '/blog/best-rated-ai-virtual-receptionist-voice-quality', tagline: 'Which providers sound the most natural.' },
];
